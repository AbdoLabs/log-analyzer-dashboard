...
if uploaded_file is not None:
      ...
      with col2_main:
        st.markdown(
        "<h4 style='text-align:center; color:black;'>Log Level Distribution</h4>",
        unsafe_allow_html=True
        )
      ...
      with col3:
              #st.markdown("#### Log Levels Over Time" )
            ...
            #-------- test fig 3----------
              ...
              # fig.update_yaxes(
              #     title_standoff=5,
              #     range=[0, level_hourly.values.max() + 5],
              #     showline=True,
              #     linewidth=1,
              #     linecolor='black',
              #     mirror=True,
      ...
      with col1:
          ...
          #---------------------------------------
      with col2:
          #message=f"{level_filter} Trend Over Time" +" (" + hour_text + ")"
          st.markdown("##### " + level_filter + " Log Activity Over Time" +" (" + hour_text + ")" )
          #st.markdown("#### Events by Hour" +" (" + hour_text + ")")
          #st.caption(hour_text)
          #events_per_hour = filtered_df.groupby("hour").size()
          #---- est fig 3----------------------
          import plotly.graph_objects as go
